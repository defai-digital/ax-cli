...
> 📖 本翻譯基於 [README.md @ v5.1.19](./README.md)
...
| 版本 | 亮點 |
|------|------|
| **v5.1.19** | 效能：依賴分析 O(N×M) → O(N+M)，快取清理最佳化，UI 修復 |
| **v5.1.18** | 重構：命名常數、變數命名統一，6,205 個測試通過 |
| **v5.1.17** | 修復：ESC 取消 bug、計時器洩漏、MCP 超時處理 |

[在 GitHub 查看完整更新紀錄 →](https://github.com/defai-digital/ax-cli/releases)
