...
*   **v4.4.2**: Context optimization fix - Fixed project context injection that was consuming 65% of context at startup. Reduced from 69,000 tokens to 145 tokens (99.8% reduction). AI can still read full ax.index.json via view_file when needed.
