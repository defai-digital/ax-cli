...
> **중요:** Z.AI가 공식 CLI 도구 **OpenCode**를 출시했습니다. GLM/Z.AI 사용자는 ax-glm 대신 OpenCode를 직접 사용하시기 바랍니다. OpenCode 시작하기: https://opencode.ai. ax-glm 클라우드 패키지는 더 이상 사용되지 않으며 공식 Z.AI 솔루션을 위해 이 저장소에서 제거되었습니다.
>
...
> **GLM/Z.AI 사용자:** ax-glm 대신 Z.AI 공식 [OpenCode CLI](https://opencode.ai)를 사용하세요.
...
> **GLM/Z.AI 사용자:** Z.AI 공식 [OpenCode CLI](https://opencode.ai)를 사용하세요.
...
> **GLM/Z.AI 사용자:** ax-glm은 더 이상 사용되지 않습니다. Z.AI 공식 [OpenCode CLI](https://opencode.ai)를 사용하세요.
