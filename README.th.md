...
> **สำคัญ:** แพ็คเกจ ax-glm คลาวด์ถูกยกเลิกแล้ว สำหรับการเข้าถึง API คลาวด์ GLM เราแนะนำให้ใช้ OpenCode เริ่มต้นกับ OpenCode: https://opencode.ai
>
...
> **ผู้ใช้ GLM:** กรุณาใช้ [OpenCode CLI](https://opencode.ai) แทน ax-glm
...
> **หมายเหตุ:** ax-glm ถูกยกเลิกแล้ว กรุณาใช้ [OpenCode CLI](https://opencode.ai)
