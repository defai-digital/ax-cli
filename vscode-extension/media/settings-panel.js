...
class SettingsPanel {
          ...
          <div class="settings-section">
            ...
            <div class="settings-field">
              ...
              <input
                ...
                value="${this.escapeHtml(this.settings.apiKey || '')}"
              />
              <small class="settings-help">API key for your AI provider</small>
            </div>
  ...
  collectSettings() {
    return {
      apiKey: this.container.querySelector('#apiKey')?.value || '',
      baseURL: this.container.querySelector('#baseURL')?.value || '',
      model: this.container.querySelector('#model')?.value || '',
      maxToolRounds: parseInt(this.container.querySelector('#maxToolRounds')?.value || '400'),
      ...
      temperature: parseFloat(this.container.querySelector('#temperature')?.value || '0.7'),
      maxTokens: parseInt(this.container.querySelector('#maxTokens')?.value || '4096'),
    };
  }
