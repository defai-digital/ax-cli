...
export interface IPCMessage {
  type: 'diff_preview' | 'task_complete' | 'status_update' | 'ping' | 'stream_chunk' | 'chat_request';
  payload: DiffPayload | TaskSummaryPayload | StreamChunkPayload | ChatRequestPayload | { status: string } | null;
  requestId: string;
}
