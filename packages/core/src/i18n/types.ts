...
export interface CommandTranslations {
  ...
  setup: {
    ...
    languageChanged: string;
    configExists: string;
    configExistsTitle: string;
    serverSelection: string;
    selectServerType: string;
    cloudRecommended: string;
    cloudHint: string;
    localCustom: string;
    localHint: string;
    localServerOptions: string;
    ...
    continueAnywayHint: string;
    cancelSetup: string;
    cancelHint: string;
    proceedingWithoutValidation: string;
    ...
    automatosxInstalled: string;
    runAxList: string;
    automatosxInstallFailed: string;
    skippingAutomatosx: string;
    agentFirstMode: string;
    agentFirstDesc: string;
    agentFirstKeywords: string;
    agentFirstDefault: string;
    enableAgentFirst: string;
    agentFirstEnabled: string;
    agentFirstEnabledInfo: string;
    agentFirstDisabled: string;
    agentFirstDisabledInfo: string;
    skippingAgentFirst: string;
    projectInit: string;
    projectInitDesc: string;
    projectInitBenefit: string;
    initProjectNow: string;
    analyzingProject: string;
    projectInitSuccess: string;
    created: string;
    projectAnalysisFailed: string;
    initLater: string;
    projectInitFailed: string;
    skippingProjectInit: string;
    ...
    reproducibleOutput: string;
    useVisionModel: string;
