...
> **重要：** ax-glm クラウドパッケージは非推奨となりました。GLM クラウド API アクセスには、OpenCode のご利用をお勧めします。OpenCode を始める：https://opencode.ai。
>
...
> **GLM ユーザー：** ax-glm の代わりに [OpenCode CLI](https://opencode.ai) をご利用ください。
...
> **GLM ユーザー：** [OpenCode CLI](https://opencode.ai) をご利用ください。
...
> **GLM ユーザー：** ax-glm は非推奨です。[OpenCode CLI](https://opencode.ai) をご利用ください。
